        	...
        	<div class="mainCon">
               ...
               <div class="mainConcls">
                    ...
                    <div class="mainConcls3">
                    	...
                    	<table id="dg" class="easyui-datagrid" style="width:1077px;height:450px"  data-options="url:'../labourmanage/query.do',singleSelect:true,fitColumns:true,singleSelect:true,pagination:true,rownumbers:true">
                        	<thead>
                            	<tr>
   ...
   <script type="text/javascript">
        ...
        function edituser() {
            ...
            if (row) {
                ...
                $("#fm").form("load", row);
                url = "../labourmanage/update.do?id=" + row.id;
            }
        }
		...
		function saveuser(){  
			...
			var signData = $("#signData").val(); //获取签约日期
			...
			if(signData==""){layer.msg("请输入签约日期");return false;}
