	...
	$(function(){
		...
		$.ajax({
			...
			success:function(data){				
				$("#name").val(data.name);
				if(data.sex=="0"){
					$("#sex1").attr("checked","checked").siblings().removeAttr("checked");
				}else{
					$("#sex2").attr("checked","checked").siblings().removeAttr("checked");
				}
		...
		$("#save").click(function(){
			...
			var url = '../drivermanage/update.do?id='+id;
			$.ajax({
				type:"post",
				url:url,
				dataType:'json',
   ...
   <div class="container detailcls detailcls2">
   		<div class="mainCon" >
        	...
        	<div class="formcls">
                ...
                <div data-title="性别">
                	<span class="radio">
                        <input type="radio" name="sex" value="0"  id="sex1" checked="checked"/>男
                        <input type="radio" name="sex" value="1"  id="sex2" style="margin-left:20px"/>女
                    </span>
                </div>
                ...
                <div data-title="体重(KG)">
                 ...
                 <div data-title="应聘形式">
                 	<span class="radio">
                        <input type="radio" name="isSpecificduty" value="1"  id="radio1" checked="checked"/>兼职
                        <input type="radio" name="isSpecificduty" value="0"  id="radio2" style="margin-left:20px"/>全职
                    </span>
                </div>
                 <div data-title="名下是否有自驾车">
                	<span class="radio" >
                        <input type="radio" name="hasCar" value="1" checked="checked"/>是
                        <input type="radio" name="hasCar" value="0"  style="margin-left:35px"/>否
                    </span>
                </div>
